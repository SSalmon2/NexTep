...
class MainUi(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.recommend_button_3.setText("")
        self.recommend_button_3.setIcon(QtGui.QIcon('./Ui_images/r3.jpg'))
        ...
        self.recommend_button_4.setText("")
        self.recommend_button_4.setIcon(QtGui.QIcon('./Ui_images/r4.jpg'))
        ...
        self.recommend_button_5.setText("")
        self.recommend_button_5.setIcon(QtGui.QIcon('./Ui_images/r5.jpg'))
    ...
    def chick_1video(self):
        video_path = "/mnt/NexTep/Main_code/video/1.JENNIE_SOLO.mp4"
        video_csv = r"./value_csv/1.csv"
        self.on_SecondWindow_clicked(video_path, video_csv)

    def chick_2video(self):
        video_path = "/mnt/NexTep/Main_code/video/2.webm"
